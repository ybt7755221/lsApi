    ...
    <div class="row">
        ...
        <div class="col-md-5">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-heading bg-black text-grey">{{trans('system.dashboard')}} -- {{trans('system.status')}} & {{trans('system.notice')}}</div>
                <!--the project information header-->
            ...
            <div class="panel panel-default">
                <ul class="list-group">
                    <li class="list-group-item bg-black text-grey ">{{trans('system.dashboard')}} -- {{trans('system.system_infomation')}}</li>
