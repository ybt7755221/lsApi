            ...
            <form class="form-horizontal" role="form" method="POST" action="{{ url('/login') }}">
              ...
              <div class="form-group">
                <div class="col-md-6 col-md-offset-4">
                  ...
                  <a class="btn btn-link" id="forget_password" data-toggle="modal"
                     data-target="#myModal">{{ trans('auth.forgotPassword') }}</a>
                </div>
              </div>
            </form>
          </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">{{trans('auth.forgotPassword')}}</h4>
        </div>
        <div class="modal-body">
          <p>{{trans('auth.connectAdmin', ['email' => 'ybt7755221@sohu.com'])}}</p>
        </div>
